...
public class WebUIActions2 {

    public WebDriver driver;

    public  WebUIActions2(WebDriver driver)
    {
        this.driver=driver;
    }
    ...
    {
        WebElement element1  = WaitUntil(element, ExpectedConditionsof_Element.presenceOfElement);
        try {
            if (clear) {
                element1.clear();
    ...
    public WebElement WaitUntil(By element_Locator , ExpectedConditionsof_Element condition)
    {
        try
        {
...
//                    element = (WebElement) new WebDriverWait(driver,6).until(ExpectedConditionsof_Element.presenceOfElement);
                    return element ;

                case elementToBeClickable:
  //                  element = (new WebDriverWait(driver,6).until(ExpectedConditionsof_Element.elementToBeClickable));
                    return element ;
    ...
    public enum ExpectedConditionsof_Element
    {
        presenceOfElement,
